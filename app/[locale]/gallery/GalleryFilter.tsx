          ...
          return (
            <button
              ...
              className={`
                ...
                ${
                  isActive
                    ? 'bg-brand-secondary text-brand-dark shadow-2xl shadow-brand-secondary/50 scale-110 border-2 border-brand-secondary'
                    : 'bg-white/80 dark:bg-brand-dark/80 text-brand-primary dark:text-brand-accent hover:bg-brand-accent/30 dark:hover:bg-brand-primary/30 border-2 border-brand-secondary/30 dark:border-brand-secondary/20 hover:border-brand-secondary/50 backdrop-blur-sm'
                }
              `}
