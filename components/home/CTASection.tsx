...
export function CTASection({ locale }: { locale: string }) {
    ...
    return (
        <Section className="relative overflow-hidden leather-texture bg-gradient-to-br from-brand-primary via-brand-dark to-brand-primary text-white text-center py-24 md:py-32">
